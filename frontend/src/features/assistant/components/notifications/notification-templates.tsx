...
const templates: NotificationTemplate[] = [
  ...
  },
  {
    ...
    description: "Information sur une fermeture exceptionnelle du cabinet",
    subject: "Information : Fermeture exceptionnelle du cabinet",
    body: "Bonjour,\n\nNous vous informons que notre cabinet médical sera exceptionnellement fermé le [DATE] pour [RAISON].\n\nSi vous aviez un rendez-vous prévu ce jour-là, notre secrétariat vous contactera pour le reprogrammer.\n\nNous vous remercions pour votre compréhension.\n\nCordialement,\nL'équipe médicale",
    type: "general",
  },
  {
    id: "7",
    title: "Rappel de vaccination",
    description: "Rappel pour une vaccination à effectuer",
    subject: "Rappel : Vaccination à prévoir",
    body: "Bonjour,\n\nSelon nos dossiers, il est temps de prévoir votre prochain vaccin [TYPE DE VACCIN].\n\nVeuillez prendre rendez-vous avec notre cabinet dans les prochaines semaines.\n\nCordialement,\nL'équipe médicale",
    type: "general",
  },
]

export function NotificationTemplates({ onSelectTemplate }: NotificationTemplateProps) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[625px]">
        <DialogHeader>
          <DialogTitle>Modèles de notification</DialogTitle>
          <DialogDescription>Choisissez un modèle prédéfini pour votre notification</DialogDescription>
        </DialogHeader>
