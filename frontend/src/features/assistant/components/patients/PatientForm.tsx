    ...
    <FormProvider {...methods}>
      <form onSubmit={handleSubmit((data) => mutation.mutate(data))} className="space-y-8 max-w-3xl mx-auto">
        <div className="flex items-center mb-6">
          <Button variant="ghost" size="icon" type="button" onClick={() => navigate("/assistant/patients")} className="mr-2">
        ...
        <CardFooter className="flex justify-end gap-4">
          <Button variant="outline" type="button" onClick={() => navigate("/assistant/patients")}>
            Annuler
          </Button>
