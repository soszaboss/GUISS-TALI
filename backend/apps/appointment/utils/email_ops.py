...
from apps.appointment import messages_ as email_messages
from apps.appointment.email_sender import notify_admin, send_email
from apps.appointment.logger_config import get_logger
from apps.appointment.models import AppointmentRequest, EmailVerificationCode, PasswordResetToken, Appointment
from apps.appointment.settings import APPOINTMENT_PAYMENT_URL
from apps.appointment.utils.date_time import convert_24_hour_time_to_12_hour_time
from apps.appointment.utils.db_helpers import get_absolute_url_, get_website_name
from apps.appointment.utils.ics_utils import generate_ics_file
